...
import AcceptTaskPageContainer from "views/Pages/AcceptTaskPageContainer";
import CompleteTaskPageContainer from "views/Pages/CompleteTaskPageContainer";
...
var dashRoutes = [
  ...
  // },
  {
    ...
    views: [
      ...
      {
        path: "/forms/accept-task",
        name: "Accept Task Page", 
        mini: "CT", 
        component: AcceptTaskPageContainer
      },
      {
        path: "/forms/complete-task",
        name: "Complete Task Page", 
        mini: "CT", 
        component: CompleteTaskPageContainer
      }
      // ,      
      // {
